...
export class VisualizerPanelProvider {
    public static currentPanel: VisualizerPanelProvider | undefined;
    ...
    public static createOrShow(extensionUri: vscode.Uri) {
        ...
        if (VisualizerPanelProvider.currentPanel) {
            VisualizerPanelProvider.currentPanel._panel.reveal(column);
            return;
        }

        // Otherwise, create a new panel.
        const panel = vscode.window.createWebviewPanel(
            'agentStudioVisualizer',
            'AgentStudio: Swarm Visualizer',
        ...
        VisualizerPanelProvider.currentPanel = new VisualizerPanelProvider(panel, extensionUri);
    }
    ...
    public dispose() {
        VisualizerPanelProvider.currentPanel = undefined;
        this._panel.dispose();
    ...
    private _getHtmlForWebview(webview: vscode.Webview) {
        ...
        return `<!DOCTYPE html>
            ...
            <head>
                ...
                <title>AgentStudio Visualizer</title>
            </head>
            <body>
                <div id="root"></div>
